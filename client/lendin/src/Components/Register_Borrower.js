...
const Register_Borrower = () => {
    ...
    const HandleSubmit = async (e) => {
        e.preventDefault();
        try {
                const serverResponse = await axios.post("http://localhost:3001/Register_Borrower", {
    ...
    return (
        <div>
            <form onSubmit={HandleSubmit} >
                ...
                <input type="text" id="borrower_name" name="borrower_name"/><br/>

                <label for="borrower_contact_number">Contact Number:</label>
                <input type="text" id="borrower_contact_number" name="borrower_contact_number"/><br/>

                <label for="borrower_email">Email:</label>
                <input type="email" id="borrower_email" name="borrower_email"/><br/>

                <label for="borrower_password">Password:</label>
                <input type="password" id="borrower_password" name="borrower_password"/><br/>

                <label for="borrower_address">Address:</label>
                <input type="text" id="borrower_address" name="borrower_address"/><br/>

                <label for="borrower_aadhar">Aadhar Number:</label>
                <input type="text" id="borrower_aadhar" name="borrower_aadhar"/><br/>

                <label for="borrower_pan">PAN Number:</label>
                <input type="text" id="borrower_pan" name="borrower_pan"/><br/>
                ...
                <input type="file" id="borrower_pan_image" name="borrower_pan_image"/><br/>

                <label for="borrower_aadhar_image">Aadhar Image:</label>
                <input type="file" id="borrower_aadhar_image" name="borrower_aadhar_image"/><br/>
