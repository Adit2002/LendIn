...
const Register_Investor = () => {
    ...
    const HandleSubmit = async (e) => {
        ...
        try {
            const serverResponse = await axios.post("http://localhost:3001/Register_Inv", {
    ...
    return (
        <div>
            ...
            <input type="text" id="investor_contact_number" name="investor_contact_number" required/><br/>

            <label for="investor_email">Email:</label>
            <input type="email" id="investor_email" name="investor_email" required/><br/>

            <label for="investor_password">Password:</label>
            <input type="password" id="investor_password" name="investor_password" required/><br/>

            <label for="investor_pan">PAN Number:</label>
            <input type="text" id="investor_pan" name="investor_pan" required/><br/>

            <label for="investor_aadhar">Aadhar Number:</label>
            <input type="text" id="investor_aadhar" name="investor_aadhar" required/><br/>

            <label for="investor_address">Address:</label>
            <input type="text" id="investor_address" name="investor_address" required/><br/>
            ...
            <input type="file" id="investor_pan_image" name="investor_pan_image" accept="image/*"/><br/>

            <label for="investor_aadhar_image">Upload Aadhar Image:</label>
            <input type="file" id="investor_aadhar_image" name="investor_aadhar_image" accept="image/*"/><br/>
