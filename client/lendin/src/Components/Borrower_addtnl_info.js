  ...
  const HandleSubmit = async (e) => {
    ...
    try {
      const serverresponse = await axios.post(
        'https://lendin-1.onrender.com/brw_adtnl_info',
        {
    ...
    <div className="page">
      ...
      <div className="info-form-login">
        ...
        <form onSubmit={HandleSubmit}>
          ...
          <input type="text" id="year_of_job" name="year_of_job" />
          <br />
          <label for="value_of_curr_prop">
            Enter Estimated Current Value of Property
          </label>
          <input
            type="text"
            id="value_of_curr_prop"
            name="value_of_curr_prop"
          />
          <br />
